...
<div class="card card-primary">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    ...
                    <a href="?page=ket-domisili-blm" title="Kembali" class="btn btn-info">Data Belum Ada</a>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Keperluan/</br>Keterangan</label>
                <div class="col-sm-5">
            ...
            <input type="hidden" class="form-control" id="jns" name="jns" value= "domisili">
        ...
        <div class="card-footer">
            ...
            <a href="?page=ket-domisili" title="Kembali" class="btn btn-warning">Batal</a>
        </div>
    </form>
</div>
        <?php
    ...
    <?php
        ...
        if ($query_simpan) {
          ...
          Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
              ...
              window.location = 'index.php?page=ket-domisili';
              }
          })</script>";
        }}

...
<div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    ...
                    <a href="?page=ket-bedaidentitas-blm" title="Kembali" class="btn btn-info">Data Belum Ada</a>
                </div>
            </div>
              ...
              if (isset($_POST['cari'])){
                ...
                { echo "<script>
                    Swal.fire({title: 'Data Tidak Ditemukan',text: '',icon: 'error',confirmButtonText: 'OK'
                        ...
                        {window.location = '?page=ket-kehilangan';}
                    })</script>";
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <textarea type="text" class="form-control" id="keter" name="keter" placeholder="Keterangan" required></textarea>
                </div>
            </div>
            <div class="form-group row">
            <div class="col-sm-2">
            ...
            <input type="hidden" class="form-control" id="jns" name="jns" value= "bedaidentitas">
            ...
            <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $kode_otomatis; ?>">
                                    <?php
                                      ...
                                      $carikodee = mysqli_query($kon, "select max(id) from tb_datadirinasabah") or die (mysql_error());
                                      // menjadikannya array
                                      ...
                                      ?>
            <input type="hidden" class="form-control" id="id_domisili" name="id_domisili" value="<?php echo $kodee_otomatis; ?>">
        </div>
        <div class="card-footer">
            <input type="submit" name="Simpan" value="Simpan" class="btn btn-info">
            <a href="?page=ket-bedaidentitas" title="Kembali" class="btn btn-warning">Batal</a>
        </div>
    </form>
</div>
        <?php
    ...
    <?php
        ...
        //mulai proses simpan data
            $sql_simpan1 = "INSERT INTO tb_datadirinasabah (id,tgl,NIK,id_surat) VALUES ('".$_POST['id_domisili']."','".$_POST['tgl']."','".$_POST['nik1']."','".$_POST['id']."')";
            $sql_simpan = "INSERT INTO tb_surat (id_surat,namapetugas,nomor_srt,tgl,nik,nama,no_kk,keperluan,jenis,ttd,Keterangan) VALUES (
            '".$_POST['id']."',
            '".$_POST['nm']."',
            '".$_POST['id_domisili']."',
            '".$_POST['tgl']."',
        ...
        if ($query_simpan) {
          ...
          Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
              ...
              window.location = 'index.php?page=ket-bedaidentitas';
              }
          })</script>";
        }}

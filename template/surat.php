...
$sql_exe = mysqli_query($koneksi,$sql);
...
<strong>PEMERINTAH KABUPATEN <?php echo strtoupper($desa['kabupaten']) ?><br/>
...
<div id="kepala_surat"><img src="dist/img/logopati.png" width="100px" height="100px" id="logo_surat" valign="baseline"/>
<strong>PEMERINTAH KABUPATEN <?php echo strtoupper($desa['kabupaten']) ?><br/>
KECAMATAN  <?php echo strtoupper($desa['kecamatan']) ?><br/>
DESA  <?php echo strtoupper($desa['nama']) ?><br/></strong>
<?php echo ucwords($desa['alamat']) ?> Telp. <?php echo $desa['tlp'] ?>
...
<div class="tanda_tangan" style="float:right">
	<div>Klakahkasihan, <?php echo date("d-m-Y") ?></div>
